...
export const CASE_TYPES: CaseTypeDetail[] = [
  ...
  },
  {
    ...
    description:      'Have a personal injury case that doesn\'t fit the categories above? Call us at (877) 863-2955 — we evaluate all MI personal injury matters.',
